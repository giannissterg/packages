...
final class VariantReport {
  ...
  double get meanScore => trialCount == 0 ? 0 : trials.fold(0.0, (s, t) => s + t.score.value) / trialCount;

  int get totalTokens => trials.fold(0, (s, t) => s + t.consumedTokens);

  double get totalCostUsd => trials.fold(0.0, (s, t) => s + t.consumedCostUsd);

  Duration get meanWallClock => trialCount == 0
      ? Duration.zero
      : Duration(milliseconds: trials.fold(0, (s, t) => s + t.wallClock.inMilliseconds) ~/ trialCount);
