...
class ChatMessage {
  ...
  Iterable<FunctionCallPart> get functionCalls =>
      parts.whereType<FunctionCallPart>();

  /// Returns all function response parts in this message.
  Iterable<FunctionResponsePart> get functionResponses =>
      parts.whereType<FunctionResponsePart>();
