...
void main() {
  test('recorded real-model SDD run replays with exact usage and cost', () async {
    ...
    final envelope = jsonDecode(fixture.readAsStringSync()) as Map<String, dynamic>;
    final replayModel = ReplayVasterModel(
      tape: ModelTape.fromJson(Map<String, dynamic>.from(envelope['modelTape'] as Map)),
    );
    ...
    expect(budget.consumedTokens, equals(450302), reason: 'total tokens drifted from the recorded run');
    expect(
      budget.consumedCost,
      closeTo(0.825917, 1e-6),
