...
final class CompressionInfo {
  ...
  Map<String, dynamic> toJson() => {
    ...
    'lossy': lossy,
    if (originalMessages != null) 'originalMessages': [for (final m in originalMessages!) m.toJson()],
  };

  factory CompressionInfo.fromJson(Map<String, dynamic> json) => CompressionInfo(
  ...
  @override
  String toString() => 'CompressionInfo($compressorId, ${tokensBefore}tok before, lossy: $lossy)';
}
